 ...
 public class VisualizadorDatosCerdo extends AlgorithmAdapter {
     ...
     public void runAlgorithm(SignalManager sm, List<SignalIntervalProperties>
         ...
         try {
             ...
             if (presionA) {
                 sm.setSignalVisible("Presi�n arterial", true);
             }
             if (presionP) {
                 sm.setSignalVisible("Presi�n pulmonar", true);

             }

             if (flujos) {
                 sm.setSignalVisible("Flujo car�tida", true);
                 sm.setSignalVisible("Flujo ri��n", true);
             }

             if (flujosDelRinhon) {
                 sm.setSignalVisible("Flujo corteza", true);
                 sm.setSignalVisible("Flujo m�dula", true);
             }
             if (presionesASuavizadas) {
                 sm.setSignalVisible("P. arterial Sist.", true);
                 sm.setSignalVisible("P. arterial Diast.", true);
             ...
             if (flujosSuavizados) {
                 sm.setSignalVisible("F. car�tida suavizado", true);
                 sm.setSignalVisible("F. ri��n suavizado", true);
             }
             if (flujosDelRinhonSuavizados) {
                 sm.setSignalVisible("F. corteza suavizado", true);
                 sm.setSignalVisible("F. m�dula suavizado", true);
             }
     ...
     @Override
     public void launchExecutionGUI(JSWBManager jswbManager) {
         JDialog f = new JDialog(JSWBManager.getParentWindow(), "Configurar visualizaci�n");
         f.setModal(true);
         PanelVisualizadorCerdo p = new PanelVisualizadorCerdo();
         p.setFlujos(flujos);
         p.setFlujosDelRinhon(this.flujosDelRinhon);
