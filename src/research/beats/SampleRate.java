...
class SampleRate {
    ...
    private static int sampleRateHz = 100; //Sample rate in Hz.100
...
//    private static int ms450 = (int) (450 / SampleRate.getMsPerSample() + 0.5);
    ...
    private static int lpBufferLgth = 2 * ms25;
    ...
    static void setSampleRate(int sampleRate) {
        SampleRate.sampleRateHz = sampleRate;
...
//        SampleRate.ms450 = (int) (450 / SampleRate.getMsPerSample() + 0.5);
        ...
        SampleRate.lpBufferLgth = (2 * SampleRate.getMs25());
        SampleRate.hpBufferLgth = SampleRate.getMs125();
        SampleRate.windowWidth = SampleRate.getMs80();
    }

    static double getMsPerSample() {
        return msPerSample;
    }

    private static int getMs10() {
        return ms10;
    }

    private static int getMs25() {
        return ms25;
    }
...
//    }
    ...
    static int getMs1000() {
        return ms1000;
    }

    static int getMs1500() {
        return ms1500;
    }

    static int getDerivLength() {
        return derivLength;
    }

    static int getLpBufferLgth() {
        return lpBufferLgth;
    }

    static int getHpBufferLgth() {
        return hpBufferLgth;
    }
